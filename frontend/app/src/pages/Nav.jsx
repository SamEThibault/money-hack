    ...
    <nav className="nav-container full-sh col-sb-c">
      <div className="nav-content col-c-fe full-w">
        ...
        <ul className="nav-links col-c-fs full-w">
          ...
          <Link to="/dashboard" exact className="row-fs-c full-w">
            <p className="row-c-c">
              <MdOutlineDashboard />
            </p>
            <p className="row-c-c">Dashboard</p>
          </Link>
          <Link to="/budget" exact className="row-fs-c full-w">
            <p className="row-c-c">
              <BiMoney />
            </p>
            <p className="row-c-c">Budget</p>
          </Link>
          <Link to="/investing" exact className="row-fs-c full-w">
            <p className="row-c-c">
              <AiOutlineLineChart />
            </p>
            <p className="row-c-c">Investing</p>
          </Link>
          <Link to="/spending" exact className="row-fs-c full-w">
            <p className="row-c-c">
              <AiOutlinePieChart />
            </p>
